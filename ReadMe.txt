========================================================================
    KONSOLENANWENDUNG: LA2018A-Projektübersicht
========================================================================

Diese LA2018A-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre LA2018A-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen LA2018A.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
