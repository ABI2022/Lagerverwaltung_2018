========================================================================
    KONSOLENANWENDUNG: dieMusterklassen-Projektübersicht
========================================================================

Diese dieMusterklassen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre dieMusterklassen-Anwendung besteht.


dieMusterklassen.vcxproj
...
dieMusterklassen.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen dieMusterklassen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
